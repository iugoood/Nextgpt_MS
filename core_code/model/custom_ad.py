...
from examples.nextgpt.core_code.speechT5.model_speecht5 import SpeechT5HifiGan
from examples.nextgpt.core_code.clap.modeling_clap import ClapTextModelWithProjection
